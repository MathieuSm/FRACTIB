...
Description = """
    Write ODB reader from template and execute it
...
def Main(Arguments):
    ...
    # Read and adjust uCT scan
    uCTDir = DD / '02_uCT' / Arguments.Sample
    ...
    Show.IRange = [0.3, 1.7]
    Show.FName = str('DetF')
    Show.Intensity(PreI, SC, Axis='X')

    Show.IRange = [1.7, 2.0]
    Show.FName = str('Ftilde')
