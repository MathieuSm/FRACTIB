...
\begin{document}
	...
	\begin{frame}
		...
		\centering
		\includegraphics[width=0.7\linewidth]{RefNodes}
	...
	\begin{frame}
		...
		\centering
		\animategraphics[controls, width=\linewidth]{30}{PP_NL/IM_}{00}{04}

	\end{frame}
	
	\begin{frame}
		\frametitle{Perfect Plasticity + Density}

		\centering
		\animategraphics[controls, width=\linewidth]{30}{PPD_NL/IM_}{00}{09}

	\end{frame}

	\begin{frame}
		\frametitle{Simple Softening}

		\centering
		\animategraphics[controls, width=\linewidth]{30}{SS_NL/IM_}{00}{04}

	\end{frame}

	\begin{frame}
		\frametitle{Simple Softening + Density}

		\centering
		\animategraphics[controls, width=\linewidth]{30}{SSD_NL/IM_}{00}{04}
