...
\begin{frame}
	...
	\begin{columns}
		...
		\begin{figure}
			\includegraphics[width=1\linewidth,trim=50 0 50 0]{Pictures/01_TimeVSDSC}
		\end{figure}
		\column[c]{0.45\linewidth}
		\centering
		A: $10^1$
		\begin{figure}
			\includegraphics[width=1\linewidth,trim=50 0 50 0]{Pictures/01_AVSDSC}
		\end{figure}
	\end{columns}
\end{frame}
...
\begin{frame}
	\frametitle{Results}
	\begin{figure}
		\includegraphics[width=0.8\linewidth]{Pictures/02_DSCSamples}
	\end{figure}
\end{frame}
