...
\begin{document}
	...
	\begin{frame}
		...
		\begin{columns}
			\column[t]{0.45\linewidth}
			\includegraphics[width=\linewidth]{Pictures/J_2_07}
			Spherical compression
			
			\column[t]{0.45\linewidth}
			\includegraphics[width=\linewidth]{Pictures/F_2_07}
			Isovolumic deformation
		\end{columns}
		
		Simulation time: \textasciitilde4 min \hfill Max displacement: \textasciitilde0.7 mm		
	\end{frame}
	...
	\begin{frame}
		...
		\begin{columns}
			\column[t]{0.45\linewidth}
			\includegraphics[width=\linewidth]{Pictures/J_0_10}
			Spherical compression
			
			\column[t]{0.45\linewidth}
			\includegraphics[width=\linewidth]{Pictures/F_0_10}
			Isovolumic deformation
		\end{columns}
