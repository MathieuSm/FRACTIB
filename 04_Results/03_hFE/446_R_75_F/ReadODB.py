...
print '\n\n'
print 'Open odb file 446_R_75_F'
Directory = '/home/ms20s284/FRACTIB/04_Results/03_hFE/446_R_75_F/'
odb = openOdb(path=Directory + '446_R_75_F.odb')

# Create a variable that refers to the
# last frame of the first step.

LastFrame = odb.steps['Step-' + str(2)].frames[12]
