...
print '\n\n'
print 'Open odb file 448_L_80_M'
Directory = '/home/ms20s284/FRACTIB/04_Results/03_hFE/448_L_80_M/'
odb = openOdb(path=Directory + '448_L_80_M.odb')

# Create a variable that refers to the
# last frame of the first step.

LastFrame = odb.steps['Step-' + str(2)].frames[24]
