...
print '\n\n'
print 'Open odb file 454_L_94_F'
Directory = '/home/ms20s284/FRACTIB/04_Results/03_hFE/454_L_94_F/'
odb = openOdb(path=Directory + '454_L_94_F.odb')

# Create a variable that refers to the
# last frame of the first step.

LastFrame = odb.steps['Step-' + str(2)].frames[3]
